...
import ServicesInteractive from "../components/subsections/Services";
    ...
    <>
      ...
      <main className="min-h-[100dvh] px-7 sm:px-20 lg:px-28 xl:px-40 flex items-center justify-center bg-gradient-to-b from-blue-100 via-white to-white">
        <div className="flex flex-col-reverse md:flex-row items-center justify-around">
          <ScrollAnimation className="flex flex-col items-center md:items-start md:mr-10">
      ...
      >
        <ScrollAnimation className="flex flex-col md:flex-row justify-center items-center md:gap-10">
        ...
        <ScrollAnimation className="flex flex-col items-center lg:items-stretch lg:flex-row justify-center">
      ...
      >
        <div className="flex flex-col items-center">
          <ScrollAnimation className="flex gap-3 lg:gap-7 items-center justify-center">
      ...
      <section
        ...
        id="portofolio"
      >
        <ScrollAnimation className="rounded-lg p-2 md:p-5 absolute left-1/2 -translate-x-1/2 flex items-center w-max bg-gray-50 border-2 border-blue-300 -mt-10">
          <img
        ...
        <ScrollAnimation className="flex flex-wrap justify-center gap-3 md:gap-5 pt-28 text-gray-900">
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <ScrollAnimation className="flex flex-wrap justify-center gap-3 md:gap-10 mt-10">
      ...
      >
        <div className="flex flex-col items-center md:items-stretch md:flex-row justify-center gap-10 pt-32">
          <ScrollAnimation direction="left" className="flex flex-col max-w-md">
            <h1 className="font-poppins text-blue-900 text-3xl lg:text-4xl font-semibold">
              Hubungi Kami
            </h1>
