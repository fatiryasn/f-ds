...
const projects = [
  ...
  },
  {
    ...
    description:
      "Aplikasi seluler yang memungkinkan pengguna melaporkan kejahatan secara daring kepada pihak berwenang dengan cepat dan aman agar dapat ditanggapi dengan lebih cepat.",
  ...
  },
  {
    ...
    description:
      "Desain UI/UX yang bersih dan modern untuk situs web profil perusahaan, yang difokuskan untuk memamerkan layanan, nilai-nilai perusahaan, dan banyak lagi.",
    tech: ["UI/UX Design"],
  },
];
